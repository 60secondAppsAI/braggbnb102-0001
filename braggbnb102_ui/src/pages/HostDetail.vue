						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="ListingCount" type="text" placeholder="Enter ListingCount" v-model="hostToAdd.listingCount"></base-input>
												                  </form>
								                </div>
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Host Id</td>
							...
							<div class="detail_view_input" style="display: inline-flex;">
															...
															<tr> 
					<td class="detail_view_column_2">Listing Count</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ListingCount" type="text" placeholder="Enter ListingCount" v-model="hostDetails.listingCount"></input>
																		</div>
						</td>
														</tr>
