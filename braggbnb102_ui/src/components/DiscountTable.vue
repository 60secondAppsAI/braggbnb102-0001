    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'validFromDate',
          visible: true,
          scopedSlots: { customRender: 'validFromDate' },
          sorter: true
          //sorter: (a, b) => a.validFromDate - b.validFromDate,
		...
		dataIndex: 'validToDate',
          visible: true,
          scopedSlots: { customRender: 'validToDate' },
          sorter: true
          //sorter: (a, b) => a.validToDate - b.validToDate,
